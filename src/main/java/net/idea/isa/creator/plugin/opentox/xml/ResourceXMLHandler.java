package net.idea.isa.creator.plugin.opentox.xml;
...
import net.idea.isa.creator.plugin.opentox.resource.ResourceField;
...
public class ResourceXMLHandler {
	public static final String pluginLocation = "Plugins/OpenToxRESTPlugin";
